...
async function buildTeamFormationSvg(team, dateStr = '', timeRange = '', options = {}) {
  ...
  <!-- Footer Watermark -->
  <text x="${svgWidth / 2}" y="${svgHeight - 20}" font-size="18" font-family="Sarabun, sans-serif" fill="#64748B" text-anchor="middle">Generated by AgentVII • ${new Date().getFullYear()}</text>
  `;
