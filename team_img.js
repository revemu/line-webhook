    ...
    if (pHasWRating) {
      ...
      ratingBadgeSvg = `
        <g transform="translate(${pillX}, ${pillY})">
          ...
          ${isMom ? `<g transform="translate(-11, -8) scale(1.2)"><polygon points="53,8 55.5,14 62,14 57,18 59,24 53,20 47,24 49,18 44,14 50.5,14" fill="#FDE047"/></g>` : ''}
        </g>
      `;
    }
    ...
    return `
      <g transform="translate(${cx}, ${cy})">
        ...
        <g transform="translate(0, ${avatarR + 10})">
          ...
          <text x="-${labelBoxWidth / 2 - 24}" y="${posTextY}" font-size="24" font-family="Sarabun, sans-serif" font-weight="bold" fill="#FFFFFF" text-anchor="middle">${escapeXml(posCode)}</text>
