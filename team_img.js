    ...
    if (momPlayer) {
      ...
      mvpBarSvg = `
        ...
        <g transform="translate(40, 1390)">
          ...
          <text x="210" y="65" font-size="30" font-family="Sarabun, sans-serif" font-weight="bold" fill="#FCD34D">${isTotw ? 'WEEK MVP' : 'TEAM MVP'}</text>
          <text x="335" y="65" font-size="30" font-family="Sarabun, sans-serif" font-weight="bold" fill="#FFFFFF">• ${escapeXml(momName)}</text>
