    ...
    if (momPlayer) {
      ...
      mvpBarSvg = `
        ...
        <g transform="translate(40, 1390)">
          ...
          <!-- Crown Vector -->
          <g transform="translate(155, 38) scale(2.5)">
            <polygon points="0,12 4,2 9,8 14,2 18,12" fill="#F59E0B" stroke="#78350F" stroke-width="1"/>
          </g>
          <text x="260" y="110" font-size="30" font-family="Sarabun, sans-serif" font-weight="bold" fill="#FCD34D">${isTotw ? 'WEEK MVP' : 'TEAM MVP'}</text>
          <text x="325" y="52" font-size="30" font-family="Sarabun, sans-serif" font-weight="bold" fill="#FFFFFF">• ${escapeXml(momName)}</text>
