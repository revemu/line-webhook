...
async function buildTeamFormationSvg(team, dateStr = '', timeRange = '', options = {}) {
  ...
  <g transform="translate(40, 24)">
    ...
    <!-- Date & Time -->
    <text x="${svgWidth - 50}" y="42" font-size="28" font-family="Sarabun, sans-serif" font-weight="bold" fill="#CBD5E1">${escapeXml(WeekDate)}</text>
    <text x="${svgWidth - 50}" y="80" font-size="28" font-family="Sarabun, sans-serif" font-weight="bold" fill="#CBD5E1">${escapeXml(timeRange)}</text>
