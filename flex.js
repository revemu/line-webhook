  ...
  return {
    ...
    body: {
      ...
      contents: [
        ...
        {
          type: 'text',
          text: 'หลังจากสแกนชำระเงินเรียบร้อยแล้วรอซัก 2-3 นาทีแล้วค่อยกดส่งเพื่อการครวจสอบการชำระอัตโนมัตินะครับ บางธนาคารอาจจะยังไม่อัพเดทสลิปให้ระบบภายนอกตรวจสอบครับ',
          size: 'xs',
          color: colors.textMuted,
          wrap: true,
          align: 'center',
