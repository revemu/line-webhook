  ...
  return {
    ...
    body: {
      ...
      contents: [
        ...
        {
          type: 'text',
          text: 'หลังจากสแกนชำระเงินเรียบร้อยแล้ว รอซัก 2-3 นาทีแล้วค่อยกดส่งเพื่อการครวจสอบการชำระอัตโนมัติ บางธนาคารอาจจะยังไม่อัพเดทสลิปให้ระบบภายนอกตรวจสอบครับ',
          size: 'xs',
          color: colors.textMuted,
          wrap: true,
          align: 'start',
